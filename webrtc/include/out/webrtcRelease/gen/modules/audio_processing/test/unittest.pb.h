...
class Test : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:webrtc.audioproc.Test) */ {
 public:
  ...
  static const int kRmsDbfsAverageFieldNumber = 13;
 ...
 private:
  ...
  void set_has_rms_dbfs_average();
  void clear_has_rms_dbfs_average();
...
inline void Test::set_has_rms_dbfs_average() {
  _has_bits_[0] |= 0x00000100u;
}
inline void Test::clear_has_rms_dbfs_average() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void Test::clear_rms_dbfs_average() {
  rms_dbfs_average_ = 0;
  clear_has_rms_dbfs_average();
}
